...
import type { ApiNote, NodeIndex, ProjectDoc, Service, ServiceEndpoint } from '@/model/types'
import { isApiNote, isBlock, isPage } from '@/model/types'
import { pageOf } from '@/domain/rollup'
import { endpointId } from '@/domain/invariants'
import { featuresRealizedBy } from '@/domain/realization'
